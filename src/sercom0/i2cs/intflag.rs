...
#[doc = "Field `PREC` reader - Stop Received"]
pub type PREC_R = crate::BitReader;
#[doc = "Field `PREC` writer - Stop Received"]
pub type PREC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `AMATCH` reader - Address Match"]
pub type AMATCH_R = crate::BitReader;
#[doc = "Field `AMATCH` writer - Address Match"]
