...
pub struct USART_INT {
    ...
    pub ctrlb: CTRLB,
    #[doc = "0x08 - USART_INT Debug Control"]
    pub dbgctrl: DBGCTRL,
    _reserved3: [u8; 0x01],
    #[doc = "0x0a - USART_INT Baud"]
    pub baud: BAUD,
    #[doc = "0x0c - USART_INT Interrupt Enable Clear"]
    pub intenclr: INTENCLR,
    #[doc = "0x0d - USART_INT Interrupt Enable Set"]
    pub intenset: INTENSET,
    #[doc = "0x0e - USART_INT Interrupt Flag Status and Clear"]
    pub intflag: INTFLAG,
    _reserved7: [u8; 0x01],
    #[doc = "0x10 - USART_INT Status"]
    pub status: STATUS,
    _reserved8: [u8; 0x06],
    #[doc = "0x18 - USART_INT Data"]
    pub data: DATA,
}
