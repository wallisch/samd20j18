...
impl FORM_R {
    ...
    pub const fn variant(&self) -> Option<FORMSELECT_A> {
        match self.bits {
            0 => Some(FORMSELECT_A::SPI),
            2 => Some(FORMSELECT_A::SPI_ADDR),
            _ => None,
        }
    }
    #[doc = "SPI frame"]
    ...
    pub fn is_spi(&self) -> bool {
        *self == FORMSELECT_A::SPI
    }
    #[doc = "SPI frame with address"]
    #[inline(always)]
    pub fn is_spi_addr(&self) -> bool {
        *self == FORMSELECT_A::SPI_ADDR
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn spi(self) -> &'a mut crate::W<REG> {
        self.variant(FORMSELECT_A::SPI)
    }
    #[doc = "SPI frame with address"]
    #[inline(always)]
    pub fn spi_addr(self) -> &'a mut crate::W<REG> {
        self.variant(FORMSELECT_A::SPI_ADDR)
    }
}
