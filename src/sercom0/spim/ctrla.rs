...
impl DOPO_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DOPOSELECT_A {
        match self.bits {
            0 => DOPOSELECT_A::PAD0,
            1 => DOPOSELECT_A::PAD1,
            2 => DOPOSELECT_A::PAD2,
...
and SS on PAD\\[1\\]"]
    ...
    pub fn is_pad3(&self) -> bool {
        *self == DOPOSELECT_A::PAD3
    }
}
#[doc = "Field `DOPO` writer - Data Out Pinout"]
pub type DOPO_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, DOPOSELECT_A>;
...
and SS on PAD\\[1\\]"]
    ...
    pub fn pad1(self) -> &'a mut crate::W<REG> {
        self.variant(DOPOSELECT_A::PAD1)
    }
    #[doc = "DO on PAD\\[3\\], SCK on PAD\\[1\\]
and SS on PAD\\[2\\]"]
    #[inline(always)]
...
and SS on PAD\\[1\\]"]
    ...
    pub fn pad3(self) -> &'a mut crate::W<REG> {
        self.variant(DOPOSELECT_A::PAD3)
    }
}
