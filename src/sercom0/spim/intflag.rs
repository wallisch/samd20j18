...
#[doc = "Field `DRE` writer - Data Register Empty"]
...
#[doc = "Field `RXC` writer - Receive Complete"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dre(&mut self) -> DRE_W<INTFLAG_SPEC, 0> {
        DRE_W::new(self)
    }
    #[doc = "Bit 1 - Transmit Complete"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxc(&mut self) -> RXC_W<INTFLAG_SPEC, 2> {
        RXC_W::new(self)
    }
