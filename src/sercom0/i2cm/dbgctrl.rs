...
#[doc = "Field `DBGSTOP` reader - Debug Stop Mode"]
pub type DBGSTOP_R = crate::BitReader;
#[doc = "Field `DBGSTOP` writer - Debug Stop Mode"]
pub type DBGSTOP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbgstop(&mut self) -> DBGSTOP_W<DBGCTRL_SPEC, 0> {
        DBGSTOP_W::new(self)
    }
