...
pub struct GROUP {
    ...
    _reserved11: [u8; 0x04],
    #[doc = "0x30..0x40 - Peripheral Multiplexing n"]
    pub pmux: [PMUX; 16],
    #[doc = "0x40..0x60 - Pin Configuration n"]
