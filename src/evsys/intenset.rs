...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovr0(&mut self) -> OVR0_W<INTENSET_SPEC, 0> {
        OVR0_W::new(self)
    }
    #[doc = "Bit 1 - Channel 1 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr1(&mut self) -> OVR1_W<INTENSET_SPEC, 1> {
        OVR1_W::new(self)
    }
    #[doc = "Bit 2 - Channel 2 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr2(&mut self) -> OVR2_W<INTENSET_SPEC, 2> {
        OVR2_W::new(self)
    }
    #[doc = "Bit 3 - Channel 3 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr3(&mut self) -> OVR3_W<INTENSET_SPEC, 3> {
        OVR3_W::new(self)
    }
    #[doc = "Bit 4 - Channel 4 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr4(&mut self) -> OVR4_W<INTENSET_SPEC, 4> {
        OVR4_W::new(self)
    }
    #[doc = "Bit 5 - Channel 5 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr5(&mut self) -> OVR5_W<INTENSET_SPEC, 5> {
        OVR5_W::new(self)
    }
    #[doc = "Bit 6 - Channel 6 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr6(&mut self) -> OVR6_W<INTENSET_SPEC, 6> {
        OVR6_W::new(self)
    }
    #[doc = "Bit 7 - Channel 7 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr7(&mut self) -> OVR7_W<INTENSET_SPEC, 7> {
        OVR7_W::new(self)
    }
    #[doc = "Bit 8 - Channel 0 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd0(&mut self) -> EVD0_W<INTENSET_SPEC, 8> {
        EVD0_W::new(self)
    }
    #[doc = "Bit 9 - Channel 1 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd1(&mut self) -> EVD1_W<INTENSET_SPEC, 9> {
        EVD1_W::new(self)
    }
    #[doc = "Bit 10 - Channel 2 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd2(&mut self) -> EVD2_W<INTENSET_SPEC, 10> {
        EVD2_W::new(self)
    }
    #[doc = "Bit 11 - Channel 3 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd3(&mut self) -> EVD3_W<INTENSET_SPEC, 11> {
        EVD3_W::new(self)
    }
    #[doc = "Bit 12 - Channel 4 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd4(&mut self) -> EVD4_W<INTENSET_SPEC, 12> {
        EVD4_W::new(self)
    }
    #[doc = "Bit 13 - Channel 5 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd5(&mut self) -> EVD5_W<INTENSET_SPEC, 13> {
        EVD5_W::new(self)
    }
    #[doc = "Bit 14 - Channel 6 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd6(&mut self) -> EVD6_W<INTENSET_SPEC, 14> {
        EVD6_W::new(self)
    }
    #[doc = "Bit 15 - Channel 7 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd7(&mut self) -> EVD7_W<INTENSET_SPEC, 15> {
        EVD7_W::new(self)
    }
