...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovr6(&mut self) -> OVR6_W<INTENCLR_SPEC, 6> {
        OVR6_W::new(self)
    }
    #[doc = "Bit 7 - Channel 7 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr7(&mut self) -> OVR7_W<INTENCLR_SPEC, 7> {
        OVR7_W::new(self)
    }
    #[doc = "Bit 8 - Channel 0 Event Detection Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn evd6(&mut self) -> EVD6_W<INTENCLR_SPEC, 14> {
        EVD6_W::new(self)
    }
    #[doc = "Bit 15 - Channel 7 Event Detection Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn evd7(&mut self) -> EVD7_W<INTENCLR_SPEC, 15> {
        EVD7_W::new(self)
    }
